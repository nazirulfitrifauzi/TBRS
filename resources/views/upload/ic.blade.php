<div class="grid grid-cols-6 gap-6 mt-1">
    ...
    <div class="col-span-6">
        <div>
            ...
            <div id="ic-div1"
                class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 @error('doc_ic_no1') border-red-500 @enderror border-dashed rounded-md cursor-pointer"
                style="display: block;">
            ...
            <div id="ic-uploaded-div1"
                ...
                <span class="mt-3 inline-flex rounded-md shadow-sm">
                    <a id="ic-buttonDel1" type="button"
                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red active:bg-red-700 transition ease-in-out duration-150"
                        onclick="icDelFile1()">
                        <svg fill="currentColor" viewBox="0 0 20 20" class="w-8 h-8">
                            <path fill-rule="evenodd"
                ...
                <span id="ic-uploaded1">Tiada fail diupload.</span>
            </div>
            {{-- end test --}}
        </div>
    </div>
    ...
    <div class="col-span-6 sm:col-span-3">
        ...
        <div>
            <label for="profile_pic" class="block text-sm leading-5 font-medium text-gray-700">
                Kad Pengenalan (Hadapan) <span class="text-red-700">*</span>
            </label>
            <div id="ic-div1"
                class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 @error('doc_ic_no1') border-red-500 @enderror border-dashed rounded-md cursor-pointer"
                style="display: block;">
                ...
                <div class="text-center">
                    <input type="file" name="doc_ic_no1" id="ic1" class="hidden" />
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Salinan Kad Pengenalan Pemohon (Hadapan)
                    </p>
                    <p class="mt-1 text-xs text-gray-500">
                        JPG & PNG sahaja
                    </p>
                    ...
                    <p class="text-red-500 text-xs italic mt-4">
                        Ruangan Dokument Sokongan - Kad Pengenalan (Hadapan) diperlukan
                    </p>
                    @enderror
                </div>
            </div>
    ...
    <div class="col-span-6 sm:col-span-3">
        <div>
            <label for="profile_pic" class="block text-sm leading-5 font-medium text-gray-700">
                Kad Pengenalan (Belakang) <span class="text-red-700">*</span>
            </label>
            <div id="ic-div2"
                class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 @error('doc_ic_no2') border-red-500 @enderror border-dashed rounded-md cursor-pointer"
                style="display: block;">

                <div class="text-center">
                    <input type="file" name="doc_ic_no2" id="ic2" class="hidden" />
                    <svg class="mx-auto h-12 w-12 text-gray-400" stroke="currentColor" fill="none" viewBox="0 0 48 48">
                        <path
                            d="M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <p class="mt-1 text-xs text-gray-500">
                        Salinan Kad Pengenalan Pemohon (Belakang)
                    </p>
                    <p class="mt-1 text-xs text-gray-500">
                        JPG & PNG sahaja
                    </p>
                    @error('doc_ic_no2')
                    <p class="text-red-500 text-xs italic mt-4">
                        Ruangan Dokument Sokongan - Kad Pengenalan (Belakang) diperlukan
                    </p>
                    @enderror
                </div>
            </div>
            {{-- test --}}
            <div id="ic-uploaded-div2"
                class="mt-2 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md cursor-pointer"
                style="display:none">
                <span class="mt-3 inline-flex rounded-md shadow-sm">
                    <a id="ic-buttonDel2" type="button"
                        class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red active:bg-red-700 transition ease-in-out duration-150"
                        onclick="icDelFile2()">
                        <svg fill="currentColor" viewBox="0 0 20 20" class="w-8 h-8">
                            <path fill-rule="evenodd"
                ...
                <span id="ic-uploaded2">Tiada fail diupload.</span>
            </div>
            {{-- end test --}}
        </div>
    </div>
