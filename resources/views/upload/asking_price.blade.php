<div class="mt-6" id="ask_div">
    ...
    <div id="ask-div"
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900">
                                Padam Fail Sebut Harga!
                            </h3>
                            <div class="mt-2">
                                <p class="text-sm leading-5 text-gray-500">
                                    Adakah anda pasti untuk memadam fail sebut harga ini?
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                        <span class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                            <button type="button"
                                ...
                                onclick="event.preventDefault();deleteAsk({{auth()->user()->pinjaman->id}})">
                                Padam!
                            </button>
                        </span>
        ...
        <div class="text-center">
            <input type="file" name="doc_ask" id="ask" class="hidden" />
            ...
            <p class="mt-1 text-xs text-gray-500">
                Salinan sebut harga pembelian motosikal daripada pembekal yang sah
            </p>
            <p class="mt-1 text-xs text-gray-500">
                PDF sahaja
            </p>
            ...
            <p class="text-red-500 text-xs italic mt-4">
                Ruangan Dokumen Sokongan - Salinan sebut harga diperlukan
            </p>
            @enderror
        </div>
        @endif
    ...
    <div id="ask-uploaded-div"
        ...
        <span class="mt-3 inline-flex rounded-md shadow-sm">
            <a id="ask-buttonDel" type="button"
                class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-red-600 hover:bg-red-500 focus:outline-none focus:border-red-700 focus:shadow-outline-red active:bg-red-700 transition ease-in-out duration-150"
                onclick="askDelFile()">
                <svg fill="currentColor" viewBox="0 0 20 20" class="w-8 h-8">
                    <path fill-rule="evenodd"
        ...
        <span id="ask-uploaded">Tiada fail diupload.</span>
    </div>
    {{-- end test --}}
</div>